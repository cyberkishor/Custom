...
//        deleteBtn.setVisible(false);
    ...
    private void initComponents() {
        ...
        edit_office = new javax.swing.JComboBox();
        ...
        jLabel7.setText("USER INFO UPDATE");

        edit_office.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "TIA00", "TIA01", "TIA02", "DOC" }));
        ...
        password_change.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                password_changeStateChanged(evt);
            }
        });
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {edit_contact, edit_fname, edit_lname, edit_office, edit_password});
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(edit_office, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel4))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitActionPerformed
        ...
        String officecode = (String) edit_office.getSelectedItem();
        String username = (String) trim(edit_user.getText());
        String Pswd = (String) trim(edit_password.getText());
        String role_id = Integer.toString(edit_role.getSelectedIndex());
        String pswd = Pswd;
        if(this.is_active==1){
        ...
        if(error.equals("")){
            try{
                ...
                String updateParams[] = {firstname,lastname,phone,officecode,username,pswd, role_id,Integer.toString(eUser.getUserId() ), userId.getText()};

                if (1 == connection.dbExecute(updateSQL, updateParams)){
                    Errormsg.setText("");
    ...
    private void userTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userTableMouseClicked
        ...
        try{
            ...
            if(rs.next()){
                ...
                edit_lname.setText(rs.getString("last_name"));
                edit_contact.setText(rs.getString("phone"));
                
                edit_office.setSelectedItem(rs.getString("office"));
    ...
    private void searchKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchKeyTyped
        ...
        String sql = "SELECT id,first_name,username,role_id From users where first_name like '%"+sq+"%'";
        this.fillUserTable(sql);
    }//GEN-LAST:event_searchKeyTyped

    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        // TODO add your handling code here:
       if(JOptionPane.showConfirmDialog(null, "Are u Sure ?", "Custom", JOptionPane.OK_CANCEL_OPTION) == 0)
        {
    ...
    private void password_changeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_password_changeStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_password_changeStateChanged
...
//        userTable.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private javax.swing.JComboBox edit_office;
